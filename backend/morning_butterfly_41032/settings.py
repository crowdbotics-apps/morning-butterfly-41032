"""
Django settings for morning_butterfly_41032 project.
...
ROOT_URLCONF = 'morning_butterfly_41032.urls'
...
WSGI_APPLICATION = 'morning_butterfly_41032.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "morning_butterfly_41032 API",
    "DESCRIPTION": "API documentation for morning_butterfly_41032 App",
    "VERSION": "v1",
}
